  ...
  text: (
    <>
      ...
      <p>
        ...
        company message, then restructured content representation in a visually pleasing way during
        pages design!!! to implement it later on a time-tested pair of GatsbyJS + Headless WP, which
        made possible to create custom marketing pages on a whim with the library of reusable
        components. It took us just under 2 months to complete the whole platform!
      </p>
      <p>
        We believe it played a role in the events that took place shortly after: Flagsmith made it
        to Product Hunt top 5 and received 2 acquisitions offers.
      </p>
    </>
  ),
  services: [
