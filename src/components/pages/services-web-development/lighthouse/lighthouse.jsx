...
const Lighthouse = () => (
  <section className="safe-paddings mt-52 lg:mt-44">
    <div className="container">
      <h2 className="mx-auto max-w-[1008px] text-center text-6xl font-normal leading-snug lg:text-5xl">
        Always in the upper <span className="text-red">Lighthouse</span> threshold to outperform
        competitors
      </h2>
      <ul className="mt-16 flex justify-center space-x-44 lg:mt-12 lg:space-x-32">
        {items.map(({ name, value }, index) => (
          <li key={index}>
            <div className="relative mx-auto h-36 w-36 lg:h-28 lg:w-28">
              <div
                className="h-36 w-36 rounded-full border-[6px] border-green border-opacity-20 lg:h-28 lg:w-28 lg:border-[5px]"
                aria-hidden
              />
              <svg
                className="absolute top-1/2 left-1/2 lg:h-28 lg:w-28"
                width="144"
                height="144"
                viewBox="0 0 144 144"
                fill="none"
              ...
              <span className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 text-5xl font-normal lg:text-4xl">
                {value}
              </span>
            </div>
