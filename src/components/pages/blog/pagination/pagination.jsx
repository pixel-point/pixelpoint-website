...
const Pagination = ({ activeCategory, currentPageIndex, pageCount }) => {
  const pageLinkAndBreakLinkClassName =
    'flex justify-center items-center text-base font-normal border-2 border-transparent w-10 h-10 rounded-full transition-colors duration-200 mx-2 hover:text-red sm:w-7 sm:h-7 sm:text-xs sm:mx-0.5';
