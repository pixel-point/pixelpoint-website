...
const SocialShare = ({ url }) => (
  <div className="absolute -right-20 top-0 h-full translate-x-full md:relative md:right-0 md:mt-12 md:translate-x-0 sm:mt-8">
    <div className="sticky right-0 top-5 space-y-3 md:relative md:top-0 md:flex md:justify-center md:space-y-0 md:space-x-3">
      <TwitterShareButton
