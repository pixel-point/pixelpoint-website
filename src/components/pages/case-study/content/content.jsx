  ...
  <article className="safe-paddings bg-black pt-40 text-white lg:pt-36 sm:pt-24">
    <div className="container grid-gap-x grid grid-cols-12 items-start md:block">
      <div className="col-span-8">
        ...
        <div className="mt-12 hidden rounded-xl border border-gray-9 p-7 md:block sm:px-5 sm:pt-4 sm:pb-6">
      ...
      <div className="col-start-10 col-end-13 rounded-2xl border border-gray-9 p-7 lg:col-start-9 lg:rounded-xl md:hidden">
