...
const ServicesCTA = ({ title, linkText, linkUrl }) => (
  <section className="safe-paddings mt-52 bg-gray-2 py-40 lg:mt-36 lg:py-28 md:py-24 sm:mt-20 sm:py-16">
    <div className="container text-center text-6xl font-normal leading-snug lg:text-[42px] md:text-4xl sm:text-2xl">
      <h2 className="mx-auto max-w-[800px] lg:max-w-[600px] md:max-w-[500px] sm:max-w-[382px] xs:max-w-[300px]">
        {title}
      </h2>
