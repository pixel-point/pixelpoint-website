...
Bindplane's trajectory since the rebrand speaks for itself. A top-ten contributor to the OpenTelemetry project and a Google Cloud partner since 2018, the company supports collector fleets of up to one million agents inside Fortune 100 organizations — and has since been acquired by Dynatrace, one of the world's leading observability companies.
